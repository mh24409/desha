  ...
  factory CustomerModel.fromJson(Map<String, dynamic> json) {
    ...
    return CustomerModel(
        ...
        owners: (json['owners'] as List<dynamic>?)
            ?.map((item) => OwnerModel.fromJson(item))
            .toList(),
        responsiblies: (json['responsiblies'] as List<dynamic>?)
            ?.map((item) => ResponsibilityModel.fromJson(item))
            .toList(),
        customerType: json['customer_type'] != null
            ? CustomerTypeModel.fromJson(json['customer_type'])
            : null,
        paymentTerms: json['payment_terms'] != null
            ? PaymentTermsModel.fromJson(json['payment_terms'])
            : null,
        images: images);
  }
}
